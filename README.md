...
```
cd existing_repo
git remote add origin https://projectbase.medien.hs-duesseldorf.de/bsalgert/repo-mining.git
git branch -M main
...
- [ ] [Set up project integrations](https://projectbase.medien.hs-duesseldorf.de/bsalgert/repo-mining/-/settings/integrations)
